            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 outline-none"
                  required
                />
              </div>
        ...
        {showModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/70 z-50">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-2xl p-8 w-[90%] max-w-md text-center shadow-xl">
              ...
              <button
                onClick={closeModal}
                className="px-6 py-2 rounded-xl bg-blue-400 text-gray-900 font-semibold hover:bg-blue-300 transition-all duration-300"
              >
                Close
              </button>
            </div>
