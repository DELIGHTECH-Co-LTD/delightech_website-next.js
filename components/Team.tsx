  ...
  return (
    <section className="relative bg-white dark:bg-gray-900 py-24 px-6 md:px-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        <p className="text-gray-900 dark:text-white mt-4 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {teamMembers.map((member) => (
            <div
              key={member.id}
              className="group relative rounded-3xl overflow-hidden bg-blue-300/20 backdrop-blur-md border border-white/10 hover:border-white/30 hover:shadow-2xl transition-all duration-500"
            >
              <div className="relative w-full h-80 overflow-hidden">
                ...
                {member.linkedin && (
                  <a
                    ...
                    className="absolute bottom-4 right-4  bg-white text-blue-600 p-2 rounded-full opacity-0 group-hover:opacity-100 transition duration-300 hover:scale-110"
                  >
                    <Linkedin size={18} />
                  </a>
                )}
              ...
              <div className="p-6 text-center">
                <h3 className="text-xl text-gray-900 dark:text-white font-semibold  mb-1">
                  {member.name}
                </h3>
              ...
              <div className="absolute inset-0 rounded-3xl border-2  group-hover:opacity-100 bg-gradient-to-r from-blue-400/10 via-white/5 to-blue-400/10 blur-xl transition"></div>
            </div>
          ))}
        </div>
      </div>
