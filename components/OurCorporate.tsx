    ...
    <section className=" text-white py-20 px-6 md:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          <div className="bg-blue-700 rounded-2xl p-8 shadow-md glass hover:bg-blue-600 transition duration-300">
            <Building2 className="mx-auto mb-4" size={50} />
            <h3 className="text-xl font-semibold mb-2">Diversified Business</h3>
          ...
          <div className="bg-blue-700 rounded-2xl p-8 glass shadow-md hover:bg-blue-600 transition duration-300">
            <Users className="mx-auto mb-4" size={50} />
          ...
          <div className="bg-blue-700 rounded-2xl p-8 shadow-md glass hover:bg-blue-600 transition duration-300">
            <TrendingUp className="mx-auto mb-4" size={50} />
